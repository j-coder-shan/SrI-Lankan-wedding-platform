        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl w-full bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 bg-cover bg-center h-64 md:h-auto relative" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1522413452208-996ff3f3e740?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80')" }}>
                    <div className="absolute inset-0 bg-gradient-to-br from-rose-600/90 to-purple-700/80"></div>
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-12 text-center">
                        <h2 className="text-3xl font-bold mb-2">Grow Your Business</h2>
                        <p className="text-rose-100">Login to manage your listings and connect with couples.</p>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12">
                    ...
                    <div className="flex bg-gray-100 p-1 rounded-lg mb-8">
                        <Link to="/login" className="w-1/2 text-center py-2 rounded-md hover:bg-white/50 text-sm font-medium text-gray-500 transition-all">
                            For Couples
                        </Link>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-gray-600">
                            New to WeddingHub?{' '}
                            <Link to="/vendor/signup" className="font-medium text-rose-600 hover:text-rose-500 transition-colors">
                                Apply as a Vendor
                            </Link>
                        </p>
                        <p className="text-xs text-gray-400 mt-4">
                            Are you a couple? <Link to="/login" className="text-rose-500 hover:underline">Couple Login</Link>
                        </p>
                    </div>
                </div>
            </div>
